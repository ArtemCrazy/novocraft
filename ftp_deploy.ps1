...
$files = @("front-page.php", "functions.php", "style.css", "script.js", "header.php", "footer.php", "template-parts/contact-section.php", "archive-furniture.php", "archive-project.php")
