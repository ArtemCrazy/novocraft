...
<?php endforeach; wp_reset_postdata(); ?>
        ...
        <a class="proj-card" data-date="20260115" data-area="28" data-material="МДФ" data-cat="Кухня">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"kitchen_dark_premium.jpg" alt="Тёмная кухня премиум" loading="lazy">
        ...
        <a class="proj-card" data-date="20251220" data-area="8" data-material="ЛДСП" data-cat="Гардеробная">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"wardrobe_sliding_wood.jpg" alt="Гардеробная с раздвижными дверями" loading="lazy">
        ...
        <a class="proj-card" data-date="20251205" data-area="18" data-material="ЛДСП" data-cat="Спальня">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"bedroom_white_storage.jpg" alt="Спальня с системой хранения" loading="lazy">
        ...
        <a class="proj-card" data-date="20251118" data-area="32" data-material="МДФ" data-cat="Гостиная">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"living_room_dark_accent.jpg" alt="Гостиная с тёмным акцентом" loading="lazy">
        ...
        <a class="proj-card" data-date="20251105" data-area="6" data-material="ЛДСП" data-cat="Прихожая">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"hallway_compact_hooks.jpg" alt="Компактная прихожая" loading="lazy">
        ...
        <a class="proj-card" data-date="20251022" data-area="20" data-material="МДФ" data-cat="Кухня">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"kitchen_grey_marble.jpg" alt="Серая кухня под мрамор" loading="lazy">
            <span class="proj-card__tag">Кухня</span>
          </div>
          <div class="proj-card__body">
        ...
        <a class="proj-card" data-date="20251010" data-area="14" data-material="ЛДСП" data-cat="Детская">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"childroom_neutral_study.jpg" alt="Детская с рабочей зоной" loading="lazy">
        ...
        <a class="proj-card" data-date="20250918" data-area="30" data-material="МДФ" data-cat="Гостиная">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"living_room_tv_console.jpg" alt="Гостиная стенка под ТВ" loading="lazy">
            <span class="proj-card__tag">Гостиная</span>
          </div>
          <div class="proj-card__body">
        ...
        <a class="proj-card" data-date="20250830" data-area="9" data-material="ЛДСП" data-cat="Прихожая">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"hallway_built_in_wardrobe.jpg" alt="Встроенный шкаф прихожая" loading="lazy">
            <span class="proj-card__tag">Прихожая</span>
          </div>
          <div class="proj-card__body">
        ...
        <a class="proj-card" data-date="20250814" data-area="25" data-material="МДФ" data-cat="Спальня">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"bedroom_modern_dark.jpg" alt="Тёмная современная спальня" loading="lazy">
            <span class="proj-card__tag">Спальня</span>
          </div>
          <div class="proj-card__body">
        ...
        <a class="proj-card" data-date="20250720" data-area="5" data-material="ЛДСП" data-cat="Гардеробная">
          <div class="proj-card__image">
            <img src="<?php echo site_url('../img/'); ?>"wardrobe_built_in_white.jpg" alt="Белый встроенный шкаф" loading="lazy">
            <span class="proj-card__tag">Гардеробная</span>
          </div>
          <div class="proj-card__body">
