<?php
/**
 * Reusable Contact Section — used on front-page, about, contacts, business, archive-project
 * Uses novacraft_contacts() helper for all data.
 */
            ...
            <div class="contact__cards">
              ...
              <div class="contact__card contact__card--addr">
                ...
                <div>
                  ...
                  <div class="contact__card-value"><?php echo nl2br(esc_html($c['address_nn'])); ?></div>
                </div>
              </div>
            </div>
